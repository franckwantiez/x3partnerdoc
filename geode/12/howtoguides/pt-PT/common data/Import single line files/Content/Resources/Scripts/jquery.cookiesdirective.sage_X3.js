...
;(function($) {
	$.cookiesDirective = function(options) {
		...
		var settings = $.extend({
			...
			cookieScripts: null,
			/* SAGE - URL for policy */
			privacyPolicyUri: 'https://www.sage.com/pt-pt/legal/privacidade-e-cookies/',
			...
			sageMessageText: 'O nosso site usa cookies para otimizar a sua experiência. Se você continuar navegando, está a aceitar que usemos esses cookies. Se quiser saber mais, incluindo como alterar as suas configurações, consulte nosso ',
			sageLinkText: 'Aviso de confidencialidade.',
			sageButtonText: 'Aceitar e fechar',
