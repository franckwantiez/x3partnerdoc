...
;(function($) {
	$.cookiesDirective = function(options) {
		...
		var settings = $.extend({
			...
			cookieScripts: null,
			/* SAGE - URL for policy */
			privacyPolicyUri: 'https://www.sage.com/fr-fr/legal/privacy-and-cookies/',
			...
			sageMessageText: 'Notre site web utilise des cookies pour optimiser votre expérience. Si vous poursuivez la navigation, vous acceptez que nous utilisions ces cookies. Si vous souhaitez en savoir plus, y compris comment modifier vos paramètres, veuillez consulter notre ',
			sageLinkText: 'Avis relatif à la confidentialité.',
			sageButtonText: 'Accepter et fermer',
