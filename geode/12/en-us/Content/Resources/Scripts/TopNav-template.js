$(document).ready(function(){
	...
	/* If #menu-toc -container doesn't contain skin for menu proxy, then hide it. For TopNav only. */
	if ($("#menu-toc > ._Skins_Sage_Menu_Topic_TopNav").length) {
		/* menu exists */
	} else {
		$("#menu-toc").css("display", "none");
	}	
